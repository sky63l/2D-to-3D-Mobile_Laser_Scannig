...
const double TICKS_PER_REVOLUTION = 285; // For reference purposes.
const double WHEEL_RADIUS = 0.028; // Wheel radius in meters
const double WHEEL_BASE = 0.19; // Center of left tire to center of right tire
const double TICKS_PER_METER = 1702; // Original was 2800
